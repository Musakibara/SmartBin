...
const roleBadgeColors = {
    ...
    AGENT: 'bg-gray-500/20 text-text-secondary border-gray-500/30',
}
            ...
            <div className="py-8 space-y-6 max-w-4xl mx-auto px-4 sm:px-6">
                ...
                <div className="glass rounded-xl p-6 flex flex-col sm:flex-row items-center gap-5 hover:border-emerald-500/30 transition-all duration-300">
                    {role === 'ADMIN' ? (
                        ...
                        <div className={`h-20 w-20 rounded-full bg-gradient-to-br ${roleColors[role] || roleColors.AGENT} flex items-center justify-center text-text-primary text-2xl font-bold shadow-lg shrink-0`}>
                            {initials(user?.name)}
                        </div>
                    )}
                    <div className="flex-1 text-center sm:text-left">
                        ...
                        <div className="flex items-center gap-4 mt-2 justify-center sm:justify-start text-xs text-text-muted">
                            {user?.phone && (
